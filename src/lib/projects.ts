...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: {
      pl: "Jedmar to nowoczesny frontend e-commerce zbudowany w Next.js 15 dla istniejącego sklepu PrestaShop.\n\n• 1460 produktów zsynchronizowanych z PrestaShop REST API\n• 190 kategorii z filtrami (cena, marka, dostępność)\n• Koszyk i checkout z tworzeniem zamówień przez API\n• Konto klienta z historią zamówień\n• Newsletter i formularz kontaktowy\n• Analytics: GA4, GTM, edrone\n• PWA z design systemem (złoty #ffd333)",
      en: "Jedmar is a modern e-commerce frontend built in Next.js 15 for an existing PrestaShop store.\n\n• 1460 products synced via PrestaShop REST API\n• 190 categories with filters (price, brand, availability)\n• Cart and checkout with order creation via API\n• Customer account with order history\n• Newsletter and contact form\n• Analytics: GA4, GTM, edrone\n• PWA with design system (golden #ffd333)",
    },
  ...
  },
  {
    ...
    longDescription: {
      pl: "Strona internetowa Wielkopolskiego Klubu Sportowego w Poznaniu.\n\n• 7 podstron: Główna, Trenerzy, Treningi, Sekcje, Galeria, Kontakt, Dotacje\n• Responsywny design mobile-first\n• Animacje przejść między stronami\n• Profile trenerów z doświadczeniem\n• Harmonogram treningów\n• Galeria zdjęć z zawodów",
      en: "Website for Wielkopolski Sports Club in Poznan.\n\n• 7 pages: Home, Trainers, Training, Sections, Gallery, Contact, Grants\n• Mobile-first responsive design\n• Page transition animations\n• Trainer profiles with experience\n• Training schedule\n• Competition photo gallery",
    },
    status: "live" as ProjectStatus,
    category: "strony-zrobione" as const,
  ...
  },
  {
    ...
    longDescription: {
      pl: "KS Posnania to legendarny poznański klub sportowy założony w 1907 roku.\n\n• 8 sekcji sportowych z dedykowanymi podstronami\n• Design w stylu Material Design 3\n• System kolorów z niebieskim akcentem (#004e75)\n• Responsywna nawigacja z karuzelami\n• Informacje o sponsorach i partnerach\n• Historia klubu i osiągnięcia",
      en: "KS Posnania is a legendary Poznan sports club founded in 1907.\n\n• 8 sports sections with dedicated subpages\n• Material Design 3 styling\n• Color system with blue accent (#004e75)\n• Responsive navigation with carousels\n• Sponsor and partner information\n• Club history and achievements",
    },
    status: "live" as ProjectStatus,
    category: "strony-zrobione" as const,
