...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: {
      ...
      en: [
        ...
        "The club updates content on its own, with no vendor involved",
  ...
  },
  {
    ...
    subtitle: {
      pl: "Lejek pozyskiwania klientów: strona, tracking i kampania Google Ads",
      en: "A lead funnel: website, tracking, and a Google Ads campaign",
    },
    description: {
    ...
    features: {
      pl: [
        ...
        "Przebudowa lejka na podstawie danych z własnej analityki",
      ...
      en: [
        ...
        "Funnel rebuilt on our own analytics data",
  ...
  },
  {
    ...
    title: "Rejestr Pro",
    subtitle: {
      pl: "Wyszukiwarka firm z KRS: tylko oficjalne dane",
      en: "A KRS company search engine: official data only",
    },
    description: {
  ...
  },
  {
    ...
    features: {
      pl: [
        ...
        "Audyt zakupowy oparty na AI i porównywanie cen produktów",
  ...
  },
  {
    ...
    subtitle: {
      pl: "Tracking i Google Ads: kampania na istniejącej stronie klienta",
      en: "Tracking and Google Ads: a campaign on the client's existing website",
    },
    description: {
  ...
  },
  {
    ...
    metrics: [
      ...
      { value: "1", label: { pl: "klub w pilotażu produkcyjnym", en: "club in a production pilot" } },
    ],
    ...
    features: {
      pl: [
        ...
        "Pilotaż produkcyjny w klubie pływackim",
      ],
      en: [
        ...
        "Production pilot with a swimming club",
      ],
    },
