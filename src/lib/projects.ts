...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Pool System",
    subtitle: {
      pl: "Innowacyjny system timingowy z aplikacją",
      en: "Innovative timing system with an app",
    },
    description: {
      pl: "Innowacyjny system pomiaru czasu (timing) łączący dedykowany hardware z aplikacją mobilną — pomiar na żywo, wyniki i analityka w telefonie. Obecnie w fazie demo, premiera wkrótce.",
      en: "An innovative timing system pairing dedicated hardware with a mobile app — live measurement, results and analytics on your phone. Currently in a demo phase, launching soon.",
    },
    longDescription: {
      pl: "Co robi:\nPool System to autorski system pomiaru czasu, który łączy dedykowany hardware pomiarowy z aplikacją mobilną. Pomiar w czasie rzeczywistym, wyniki na żywo w aplikacji, historia i analityka. Projekt jest w fazie demo — pełne szczegóły i dostępność wkrótce.\n\nNa czym jest zbudowany:\nDedykowany hardware pomiarowy + aplikacja mobilna (iOS/Android) spięta z urządzeniem w czasie rzeczywistym.\n\nDlaczego tak:\n• Własny hardware — pełna kontrola nad dokładnością pomiaru, niezależność od cudzych urządzeń.\n• Aplikacja mobilna — wyniki na żywo, historia i analityka w telefonie, bez papieru i ręcznego przepisywania.",
      en: "What it does:\nPool System is our own timing system that pairs dedicated measurement hardware with a mobile app. Real-time measurement, live results in the app, history and analytics. The project is in a demo phase — full details and availability soon.\n\nStack:\nDedicated measurement hardware + a mobile app (iOS/Android) paired with the device in real time.\n\nWhy:\n• Own hardware — full control over measurement accuracy, no dependence on third-party devices.\n• Mobile app — live results, history and analytics on your phone, no paper or manual entry.",
    },
    status: "planned",
    category: "nasze-systemy",
    metric: { pl: "Hardware + aplikacja · wkrótce", en: "Hardware + app · soon" },
    tech: ["Hardware", "iOS", "Android", "Real-time"],
    features: {
      pl: [
        "Pomiar czasu w czasie rzeczywistym",
        "Dedykowany hardware pomiarowy",
        "Aplikacja mobilna (iOS/Android)",
        "Wyniki na żywo, historia i analityka",
      ],
      en: [
        "Real-time timing measurement",
        "Dedicated measurement hardware",
        "Mobile app (iOS/Android)",
        "Live results, history, and analytics",
      ],
    },
