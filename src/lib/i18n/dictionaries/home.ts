...
export const home = {
  ...
  "realizations.subtitle": {
    pl: "Systemy, aplikacje i sklepy, które działają na produkcji. Kliknij, żeby zobaczyć szczegóły.",
    en: "Systems, apps and stores running in production. Click to see the details.",
  },
  ...
  // ————————————————————————————————————————————————————————————————
  // Redesign 2026-07 — conversion-first homepage. All copy 1:1 from
  // docs/content-deck-2026-07.md section 1. Namespaced `home.*`.
  // ————————————————————————————————————————————————————————————————

  // Shared
  "home.reply": { pl: "Odpowiadamy w 24 h", en: "We reply within 24 hours" },

  // 1.1 Hero
  "home.hero.eyebrow": {
    pl: "Studio oprogramowania · Poznań",
    en: "Software studio · Poznan",
  },
  "home.hero.h1": {
  ...
  "home.hero.ctaCall": { pl: "Zadzwoń: 509 123 434", en: "Call us: +48 509 123 434" },
  "home.hero.ctaConsult": { pl: "Bezpłatna konsultacja", en: "Free consultation" },
  ...
  "home.offer.exampleLabel": { pl: "Realizacja", en: "Case" },
  "home.offer.p1.title": { pl: "Aplikacje webowe i SaaS", en: "Web applications and SaaS" },
  "home.offer.p1.desc": {
    pl: "Systemy, na których firma pracuje codziennie: CRM-y, panele, platformy z płatnościami i kontami użytkowników. Budujemy je tak, żeby dane wielu klientów były od siebie twardo odizolowane, a system rósł razem z biznesem.",
    en: "Systems a company works in every day: CRMs, dashboards, platforms with payments and user accounts. We build them so that each customer's data is strictly isolated and the system grows with the business.",
  },
  "home.offer.p1.example": {
    pl: "Estalo - CRM dla biur nieruchomości, live z płatnościami",
    en: "Estalo - a CRM for real estate agencies, live with billing",
  },
  "home.offer.p2.title": { pl: "Natywne aplikacje iOS i Android", en: "Native iOS and Android apps" },
  "home.offer.p2.desc": {
    pl: "Piszemy osobno w Swift i Kotlinie, bez półśrodków w rodzaju webview. Aplikacja działa płynnie, korzysta z aparatu, powiadomień i Face ID, a proces publikacji w App Store i Google Play bierzemy na siebie.",
    en: "We write separately in Swift and Kotlin, with no webview half-measures. The app runs smoothly, uses the camera, notifications, and Face ID, and we handle the App Store and Google Play publishing process ourselves.",
  },
  "home.offer.p2.example": {
    pl: "Jedmar - dwie aplikacje sklepowe opublikowane w obu sklepach",
    en: "Jedmar - two store apps published in both app stores",
  },
  "home.offer.p3.title": { pl: "Sklepy internetowe", en: "Online stores" },
  "home.offer.p3.desc": {
    pl: "Od sklepu zbudowanego od zera po aplikację mobilną dołożoną do sklepu, który już masz. Integrujemy płatności, Paczkomaty i stany magazynowe, zamiast kazać Ci migrować coś, co działa.",
    en: "From a store built from scratch to a mobile app added to the store you already have. We integrate payments, parcel lockers, and stock levels instead of making you migrate something that works.",
  },
  "home.offer.p3.example": {
  ...
  "home.portfolio.view": { pl: "Zobacz projekt", en: "View project" },
  "home.cat.produkty": { pl: "Produkty Programo", en: "Programo products" },
  "home.cat.klienci": { pl: "Dla klientów", en: "Client work" },
  "home.cat.marketing": { pl: "Tracking i reklamy", en: "Tracking & ads" },
  ...
  "home.people.wojtek.role": { pl: "Design i Produkt", en: "Design & Product" },
  "home.people.wojtek.desc": {
  ...
  "home.people.bartosz.role": { pl: "Inżynieria", en: "Engineering" },
  "home.people.bartosz.desc": {
  ...
  "home.faq.a4": {
    pl: "Twoją. Po wdrożeniu przekazujemy kod i wszystkie dostępy. Nie musisz zostawać z nami, żeby dalej z niego korzystać.",
    en: "Yours. After launch we hand over the code and every access credential. You don't have to stay with us to keep using it.",
  },
  "home.faq.q5": { pl: "Czy zajmujecie się utrzymaniem po wdrożeniu?", en: "Do you maintain the product after launch?" },
  "home.faq.a5": {
    pl: "Tak. Po starcie zostajemy do dyspozycji i robimy poprawki, dalszy rozwój oraz wsparcie techniczne.",
    en: "Yes. After launch we stay available for fixes, further development and technical support.",
  },
  "home.faq.q6": { pl: "Od czego zacząć?", en: "How do we start?" },
  "home.faq.a6": {
    pl: "Od krótkiej wiadomości przez formularz albo od telefonu. Opisz, co dziś nie działa. Odezwiemy się w ciągu 24 godzin z propozycją kolejnego kroku.",
    en: "With a short message through the form, or a call. Describe what isn't working today. We'll reply within 24 hours with a proposed next step.",
  },
  ...
  "home.hero.desc.v2": {
    pl: "Strony, sklepy, systemy i automatyzacje AI. Od pierwszej rozmowy do wdrożenia projekt prowadzi dwóch inżynierów z Poznania, bez nikogo po drodze.",
  ...
  "home.work.wsafefinanse.problem": {
    pl: "Doradca finansowy potrzebował strony, która buduje zaufanie i zamienia ruch w zapytania, a nie tylko dobrze wygląda.",
    en: "A financial advisor needed a site that builds trust and turns traffic into inquiries, not just one that looks good.",
  },
  ...
  "home.work.wks.effect": {
    pl: "Rodzic sprawdza wszystko z telefonu pod halą. Nie ma CMS-a do utrzymania ani rachunku za hosting.",
    en: "Parents check everything on their phone outside the gym. There's no CMS to maintain and no hosting bill.",
  },
  ...
  "home.svc.block1.body": {
    ...
    en: "You have a site, but the phone stays silent. It loads slowly and leads nowhere. We build websites and stores where a visitor knows what to do next and leaves a number.",
  },
  ...
  "home.svc.block2.body": {
    pl: "Zespół przepisuje dane między arkuszami, mailami i systemami. Te same czynności co tydzień da się oddać maszynie. Budujemy panel, system albo automatyzację, która to przejmuje.",
    en: "Your team retypes data between spreadsheets, emails and systems. The same weekly chores can be handed to a machine. We build the panel, system or automation that takes them over.",
  },
  ...
  "home.svc.block3.body": {
    pl: "Chcesz uruchomić aplikację i potrzebujesz kogoś, kto zaprojektuje oraz zbuduje pierwszą działającą wersję, bez przepalania budżetu na pełny system. Zaczynamy od MVP, które od razu trafia do prawdziwych użytkowników.",
