...
const ORDER: ProductEntry[] = [
  ...
  { slug: "athlix", name: "Athlix", descKey: "home.products.athlix.desc" },
...
const statusKey: Record<ProjectStatus, TKey> = {
  live: "work.live",
...
export default function OwnProducts() {
  ...
  // with the project pages. Entries with no matching project are dropped.
