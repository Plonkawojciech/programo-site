...
function TechCard({ item }: { item: TechItem }) {
  return (
    <div
      className="group relative flex min-w-[280px] flex-col gap-4 rounded-[2rem] border border-outline-variant/10 bg-surface p-8 shadow-sm transition-all duration-300 hover:-translate-y-2.5 hover:border-primary/20 hover:shadow-2xl md:min-w-[320px]"
    >
