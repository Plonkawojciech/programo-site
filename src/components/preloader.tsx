  ...
  return (
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          {/* Static title */}
          <span className="block font-headline text-3xl font-medium italic tracking-[0.2em] md:text-5xl text-primary">
            PROGRAMO
          </span>
          ...
          {/* Bottom Bar */}
          <div className="absolute bottom-0 left-0 h-[2px] bg-primary transition-all duration-100 ease-out" style={{ width: `${progress}%` }} />
        </motion.div>
      )}
    </AnimatePresence>
  );
