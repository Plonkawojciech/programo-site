...
function ScoreRing({ score }: { score: number }) {
  ...
  return (
    <div
      ...
      style={{
        background: `conic-gradient(${color} ${score * 3.6}deg, rgba(var(--theme-text-1-rgb),0.18) 0deg)`,
      }}
    >
...
function Bar({ score }: { score: number }) {
  return (
    <div className="h-2 w-full overflow-hidden rounded-full bg-[rgba(var(--theme-text-1-rgb),0.18)]">
      <div
